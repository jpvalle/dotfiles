return {
  ...
  keys = {
    ...
    { "<leader>gm", "<cmd>DiffviewOpen HEAD~1<cr>", desc = "Compare with Previous Commit" },
    { "<leader>gb", "<cmd>DiffviewOpen origin/HEAD...HEAD --imply-local<cr>", desc = "Compare with Origin" },
  },
}
